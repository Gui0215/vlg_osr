...
from utils import strip_state_dict
...
class VGG32Wrapper(torch.nn.Module):
...
def get_model(args, wrapper_class=None, evaluate=False, *args_, **kwargs):
    ...
    elif args.model == 'vgg32':
        try:
            feat_dim = args.feat_dim
        except:
            feat_dim = None
        model = VGG32(feat_dim=feat_dim)

    elif args.model in ['resnet18', 'resnet34', 'resnet50', 'resnet101']:
        model_obj, feat_dim = model_dict[args.model]
        model = model_obj()
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='cls', formatter_class=argparse.ArgumentDefaultsHelpFormatter)
    # General
